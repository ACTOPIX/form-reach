...
function fixIntlTelInput() {
  return gulp
    .src("node_modules/intl-tel-input/build/css/intlTelInput.css")
    .pipe(replace("flags@2x.webp", "flags-2x.webp"))
    .pipe(replace("globe@2x.webp", "globe-2x.webp"))
