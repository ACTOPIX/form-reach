...
<div id="tabs">
  ...
  <div id="formulaire">
  		<input type="button" class="ed_button button button-small" aria-label="gras" value="Text">
		<input type="button" class="ed_button button button-small" aria-label="gras" value="E-mail">
		<input type="button" class="ed_button button button-small" aria-label="gras" value="Tél.">
		<input type="button" class="ed_button button button-small" aria-label="gras" value="Menu déroulant">
		<input type="button" class="ed_button button button-small" aria-label="gras" value="Cases à cocher">
		<input type="button" class="ed_button button button-small" aria-label="gras" value="Boutons radio">
		<input type="button" class="ed_button button button-small" aria-label="gras" value="Zone de text">
		<input type="button" class="ed_button button button-small" aria-label="gras" value="Date">
		<input type="button" class="ed_button button button-small" aria-label="gras" value="Fichier">
		<input type="button" class="ed_button button button-small" aria-label="gras" value="Confirmation">
		<input type="button" class="ed_button button button-small" aria-label="gras" value="Envoyer">
		<br>
		<br>
		<textarea cols="100" rows="24" class="large-tet code"></textarea>
  </div>
  <div id="email">
	<form> 
		<table>
  ...
  <div id="message">
	...
	<input type="text" id="succes" class="large-text" size="70" value="Votre message a été envoyé avec succès.">
	</label>
	<label for="erreur">
	"Le message de l'expéditeur n'a pas pu être envoyé."
	<input type="text" id="erreur" class="large-text" size="70" value="Une erreur s'est produite. Votre message n'a pas pu être envoyé.">
	</label>
