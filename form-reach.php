			...
			<div class="container">	
				<div class="row">	
					<form class="form-reach" <?php echo ($formreach_stored_meta_front['formreach_whatsapp_switch'][0] == 1) ? 'id="formreach_whatsapp"' : 'id="formreach_mail"'; ?>>
						...
						echo '<div id="formreach_submitContent" style="display:flex; align-items:center; width:fit-content; justify-content:space-around;">';
						...
						echo '<div id="formreach_submitContentWhatsapp" style="display:flex; align-items:center; width:fit-content; justify-content:space-around;"> ';
