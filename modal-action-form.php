...
<!-- WhatsApp Icon -->
<svg id="wpaf_whatsapp_iconsvg" class="wpaf_iconsvg"style="visibility:hidden" xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
...
<!-- Mail Icon -->
<svg id="wpaf_mail_iconsvg" class="wpaf_iconsvg"style="visibility:hidden" id="wpaf_mail_iconsvg" xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
